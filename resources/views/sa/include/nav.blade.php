            ...
            <div class="container">
                <nav id="menuzord" class="menuzord blue">
                    <ul class="menuzord-menu">
                        <li><a href="{{ url('/sa') }}">Home</a>
                        </li>
                        <li><a href="javascript:void(0)">About us</a>
                            <ul class="dropdown">
                                <li><a href="{{ url('sa/Quality-Policy') }}">Quality policy</a>
                                <li><a href="{{ url('sa/impartiality-policy') }}">Impartiality policy</a>
                                </li>
                            </ul>
                        </li>
                        <li><a href="javascript:void(0)">Service</a>
                            <ul class="dropdown">
                                @foreach ($certData as $item)
                                    <li>
                                        <a href="/sa/{{ $item->name }}">{{ $item->cer_name }}</a>
                                    </li>
                                @endforeach
                        ...
                        <li><a href="javascript:void(0)">Customer</a>
                            <ul class="dropdown">
                                <li><a href="{{ 'sa/Check-Status' }}">Certificate Verification</a></li>
                                <li><a href="{{ url('sa/certification-mark-guidelines') }}">Certification Mark Guidelines</a>
                                <li><a href="{{ url('sa/customer-feedback') }}">Customer Feedback</a>
                                <li><a href="{{ url('sa/apply-for-certification') }}">Apply for Certification</a>
                                <li><a href="{{ url('sa/apply-for-training') }}">Apply for Training</a>
                                <li><a href="{{ url('sa/verify-training-certificate') }}">Verify Training Certificates</a>
                                </li>
                            </ul>
                        </li>
                        <li><a href="javascript:void(0)">Resources</a>
                            <ul class="dropdown">
                                ...
                                <li><a href="{{ url('sa/Appeal-Handling-Process') }}">Appeal Handling Process</a>
                                <li><a href="{{ url('sa/Complaint-Handling-Process') }}">Comaplaint Handling Process</a>
                                <!-- <li><a href="{{ url('') }}">News & Blogs</a> -->
                                </li>
                            </ul>
                        </li>
                        <li><a href="{{ url('sa/Contact') }}">Contact us</a></li>
