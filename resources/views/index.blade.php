                                        ...
                                        <div class="project mb-30">
                                            <div class="thumb">
                                                ...
                                                <div class="hover-link">
                                                    <a href="/{{ $data->name }}"><i class="fa fa-bar-chart"></i></a>
                                                </div>
                                            </div>
                                            ...
                                            <a href="/{{ $data->name }}" target="_blank" class="btn btn-sm btn-theme-colored text-white">Learn more</a>
                                        </div>
                                    </div>
                                    <!-- Portfolio Item End -->
                                    @endforeach
